                        ...
                        <c:if test="${empty var}">
                                <form method="POST"
                                    ...
                                    <input type="hidden" name="_token" value="${_token}" /> <input
                                        type="hidden" name="report_id" value="${report.id}" /> <input
                                        type="submit" value="いいね" >
                            ...
                            <c:if test="${!empty var}">
                                <form method="POST"
                                    ...
                                    <input type="hidden" name="_token" value="{_token}" /> <input
                                        type="hidden" name="report_id" value="${report_id}" /> <input
                                        type="submit" value="いいね解除">
                                </form>
                            </c:if>
                    </tr>
                </c:forEach>
